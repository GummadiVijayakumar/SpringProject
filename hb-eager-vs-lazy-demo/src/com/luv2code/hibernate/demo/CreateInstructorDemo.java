...
public class CreateInstructorDemo
{
	public static void main(String[] args) 
	{
		...
		{			
			...
			Instructor tempInstructor = new Instructor("Patrick","WashingtonDC","PatrickWashingtonDC@Patrickvideos.com");
			
			InstructorDetail tempInstructorDetail = new InstructorDetail("patrick Videos for design pattern","Teahcing and coding");
