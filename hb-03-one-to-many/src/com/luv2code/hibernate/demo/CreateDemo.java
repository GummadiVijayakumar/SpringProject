...
public class CreateDemo
{
	public static void main(String[] args) 
	{
		...
		{			
			...
			Instructor tempInstructor = new Instructor("Scarlet","Jhonson","ScarletJhonson@avengers.com");
			
			InstructorDetail tempInstructorDetail = new InstructorDetail("avengersendgame Youtube Channel","acting and modeling");
